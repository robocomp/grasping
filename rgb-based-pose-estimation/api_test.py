...
def api_test(img_path, weights_path):
    # read test image
    img = imread(img_path)
...
if __name__ == "__main__":
    ...
    argparser.add_argument('-wp', '--weights_path', type=str, help='path to the pretrained weights file', default='models/exp-05/ckpt_final.pth')

    args = argparser.parse_args()

    # call test function
    api_test(args.image_path, args.weights_path)
