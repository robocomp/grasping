...
# \mainpage RoboComp::objectPoseEstimationRGBD
#
...
#
# Just: "${PATH_TO_BINARY}/objectPoseEstimationRGBD --Ice.Config=${PATH_TO_CONFIG_FILE}"
#
...
if __name__ == '__main__':
    ...
    adapter = ic.createObjectAdapter('ObjectPoseEstimationRGBD')
    adapter.add(objectposeestimationrgbdI.ObjectPoseEstimationRGBDI(worker), ic.stringToIdentity('objectposeestimationrgbd'))
    adapter.activate()
